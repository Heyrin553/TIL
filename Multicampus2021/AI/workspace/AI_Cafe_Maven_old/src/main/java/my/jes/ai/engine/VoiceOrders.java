...
public class VoiceOrders {
     ...
     public static String process(String voiceMessage) {
        ...
        try {
            String apiURL = "https://78a371dfea604f0e99a62f4eea263825.apigw.ntruss.com/custom/v1/4328/6b851c65407b73da5659e9d780c3def8b2ec761f3ea23ea05b158d0bc04c8b84";
 ...
 //           System.out.println("##" + message);
            ...
            DataOutputStream wr = new DataOutputStream(con.getOutputStream()); // 문자열을 보냄 
            ...
            if(responseCode==200) { // Normal call 제대로 응답한것 
                ...
                while ((decodedString = in.readLine()) != null) { // 응답을읽음 
