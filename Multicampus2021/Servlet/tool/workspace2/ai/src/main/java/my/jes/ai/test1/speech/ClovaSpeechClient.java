package my.jes.ai.test1.speech;
...
public class ClovaSpeechClient {
	...
	private static final Header[] HEADERS = new Header[] { new BasicHeader("Accept", "application/json"),
	 ...
	 * @param boostings  optional, object array => [{"words":"comma separated
	 *                   words"}]
	 * @return
	 */
	public String url(String url, String completion, String callback, Map<String, Object> userdata, String forbiddens,
	 ...
	 * @return
	 */
	public String upload(File file, String completion, String callback, Map<String, Object> userdata, String forbiddens,
			List<Boosting> boostings) {
	...
	public static void main(String[] args) {
		...
		// final String result = clovaSpeechClient.url("file URL", "sync", null, null,
		// "", null);
		// final String result = clovaSpeechClient.objectStorage("Object Storage key",
		// "sync", null, null, "", null);
